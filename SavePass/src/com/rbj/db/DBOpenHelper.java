...
public class DBOpenHelper extends SQLiteOpenHelper {
	...
	private static final String DBNAME = "bawangBowser.db";// 定义数据库名
	...
	public void onCreate(SQLiteDatabase db){// 创建数据库
		...
		db.execSQL("create table tb_pwd (_id integer  primary key autoincrement ,username varchar(20),password varchar(20),name varchar(20),email varchar(200))");// 创建密码表
